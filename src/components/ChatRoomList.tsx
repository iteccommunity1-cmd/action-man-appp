...
export const ChatRoomList: React.FC<ChatRoomListProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-sidebar rounded-none sm:rounded-xl border-r-0 sm:border-r border-sidebar-border overflow-y-auto glass-card"> {/* Adjusted rounded corners and border for mobile */}
